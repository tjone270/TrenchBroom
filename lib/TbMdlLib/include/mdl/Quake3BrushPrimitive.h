 ...
 * computeAxisBase()) to texture coordinates that are normalized so that 1.0 corresponds to
 * one full texture repeat:
 *
...
struct Quake3BrushPrimitiveMatrix
{
  ...
  friend bool operator==(
    const Quake3BrushPrimitiveMatrix& lhs, const Quake3BrushPrimitiveMatrix& rhs) = default;
};
